...
export const EVENT_ERROR_REASON_AS_OBJECT = enumToObject(
...
export const COMMON_SIMPLE_STATUS_AS_OBJECT = enumToObject(
  COMMON_SIMPLE_STATUS_ENUM
);
...
export const USER_PERMISSION_METHOD_AS_OBJECT = enumToObject(
...
export const TRANSFEROUT_REASON_AS_OBJECT = enumToObject(
  TRANSFEROUT_REASON_ENUM
);
